...
// Start LOcation Service
  ...
  Future<void> _getLocation2() async {
    ...
    if (!isInternetConnected.value) {
      ...
      locationService.onLocationChanged.listen((LocationData locationData) {
        UserModel.lat = locationData.latitude!;
        UserModel.long = locationData.longitude!;
  ...
  Future<void> _updateLocation() async {
    ...
    try{
      ...
      // Geofencing logic
      if (administrativeArea != '' && administrativeArea != null) {
        ...
        for (GeofenceModel office in offices) {
          ...
          if (distance <= office.radius) {
            ...
            setState(() {
              ...
              // isCircularProgressBarOn = false; // Update observable value
            });
