...
class AttendanceLocalDB extends StatefulWidget {
  final IsarService service;
  const AttendanceLocalDB({Key? key, required this.service}) : super(key: key);

  @override
  State<AttendanceLocalDB> createState() => _AttendanceLocalDBState();
}

class _AttendanceLocalDBState extends State<AttendanceLocalDB> {
