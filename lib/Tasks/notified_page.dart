  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
            onPressed: ()=>Get.back,
            icon: Icon(Icons.arrow_back,color: Get.isDarkMode?Colors.white:Colors.grey[600],)
        ),
        title: Text(this.label.toString().split("|")[0],
          style: TextStyle(color: Get.isDarkMode?Colors.white:Colors.black,fontFamily: "NexaBold"),
        ),
      ),
      body: Center(
        child: Container(
